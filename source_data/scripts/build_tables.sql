...
FROM '/var/lib/postgresql/source_data/csv/hyd_crime_2018.csv'
...
FROM '/var/lib/postgresql/source_data/csv/hyd_crime_2019.csv'
WITH DELIMITER ',' HEADER CSV;
...
FROM '/var/lib/postgresql/source_data/csv/hyd_crime_2020.csv'
WITH DELIMITER ',' HEADER CSV;
...
FROM '/var/lib/postgresql/source_data/csv/hyd_crime_2021.csv'
WITH DELIMITER ',' HEADER CSV;
...
FROM '/var/lib/postgresql/source_data/csv/hyd_crime_2022.csv'
WITH DELIMITER ',' HEADER CSV;

-- Create hyd Weather Table
...
FROM '/var/lib/postgresql/source_data/csv/hyd_temps_18-22.csv'
WITH DELIMITER ',' HEADER CSV;

-- Create hyd Community Area Table
...
FROM '/var/lib/postgresql/source_data/csv/hyd_areas.csv'
WITH DELIMITER ',' HEADER CSV;

-- Create an schema and tables for permanent tables
CREATE SCHEMA IF NOT EXISTS hyd;

-- Insert Crime Data from import schema
DROP TABLE IF EXISTS hyd.crimes;
CREATE TABLE hyd.crimes (
	crime_id int,
...
DROP TABLE IF EXISTS hyd.community;
CREATE TABLE hyd.community (
...
DROP TABLE IF EXISTS hyd.weather;
CREATE TABLE hyd.weather (
	weather_id int,
...
REFERENCES hyd.community (community_id);
...
REFERENCES hyd.weather (weather_date);
